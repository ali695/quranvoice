...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Theme-aware scales: values come from CSS variables in globals.css,
        // so [data-theme="light"] remaps every ink/gold/cream utility class.
        ink: {
        ...
        cream: {
          DEFAULT: 'rgb(var(--cream-200) / <alpha-value>)',

...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  mosque: (
    <>
      <path d="M12 2c1.5 2 2.5 3 2.5 5" />
  ...
  scroll: (
    <>
      <path d="M8 21h12a2 2 0 0 0 2-2v-2h-8" />
      <path d="M8 17V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v3h4" />
  ...
  android: (
    <>
      <path d="M5 18V8a7 7 0 0 1 14 0v10" />
...
export function Icon({ name, size = 20, strokeWidth = 1.75, className, ...rest }: IconProps) {
  // Filled icons render with fill; outline icons render with stroke.
  const filled: IconName[] = ['play', 'pause', 'bookmark', 'sparkle', 'star', 'crescent', 'moon', 'apple', 'twitter'];
